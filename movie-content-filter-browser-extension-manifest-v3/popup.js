...
let toggleFiltersText = document.getElementById("toggle-filters-label");
toggleFiltersText.textContent = chrome.i18n.getMessage("toggleFilters");

let yourPreferencesIDText = document.getElementById("user-preferences-id-label");
...
function checkForBlankID() {
    let yourPreferencesIDError = document.getElementById("user-preferences-id-error");
...
let isSafeSeekSliderBeingDragged = false; // Derived from the seek_dragger_being_dragged variable from "edited_generic_player.js"
